(function($) {
    ...
    const subForm = document.getElementById("edite_reivew");
  
    if(subForm){
      const reviewInformation = document.getElementById("edite_your_reivew");
      const ratingScore = document.getElementById("edite_your_rating");
      const errorContainer = document.getElementById('error-container_edite');
      const errorTextElement = errorContainer.getElementsByClassName(
        'text-goes-here-edite'
      )[0];
