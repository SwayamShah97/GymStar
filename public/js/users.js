(function($) {
    ...
    function checkInput(role,firstname, lastname, email, city, 
        ...
        if(!password2) throw "Re-Enter password again"
        ...
        if(typeof(password2) !== 'string') throw "password2 Not a string"
        ...
        // if(password2.trim().length === 0) throw "Password cannot be empty"
        ...
        if(password !== password2) throw "Password does not match"
